...
nunjucksManagementEnv.addGlobal('pluginVersionSatisfies', pluginVersionSatisfies)
...
function getTemplatesViewHandler (req, res) {
  ...
  nunjucksAppEnv.addGlobal('pluginVersionSatisfies', pluginVersionSatisfies)
